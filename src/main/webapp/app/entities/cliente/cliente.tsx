      ...
      <div className="table-responsive">
        ...
        >
          {clienteList && clienteList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('rucCi')}>
                    Ruc Ci <FontAwesomeIcon icon={getSortIconByFieldName('rucCi')} />
                  </th>
                  ...
                  <th className="hand" onClick={sort('fechaAlta')}>
                    Fecha Alta <FontAwesomeIcon icon={getSortIconByFieldName('fechaAlta')} />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {clienteList.map((cliente, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      {cliente.fechaAlta ? <TextFormat type="date" value={cliente.fechaAlta} format={APP_LOCAL_DATE_FORMAT} /> : null}
                    </td>
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button
                          onClick={() => (window.location.href = `/cliente/${cliente.id}/delete`)}
                          color="danger"
                          size="sm"
            ...
            !loading && <div className="alert alert-warning">No Clientes found</div>
          )}
        </InfiniteScroll>
      </div>
    </div>
