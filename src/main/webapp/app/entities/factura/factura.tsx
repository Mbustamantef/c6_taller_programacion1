    ...
    <div>
      <h2 id="factura-heading" data-cy="FacturaHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="/factura/nueva" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
      ...
      <div className="table-responsive">
        {facturaList && facturaList.length > 0 ? (
            ...
            <tbody>
              {facturaList.map((factura, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{factura.cliente ? <Link to={`/cliente/${factura.cliente.id}`}>{factura.cliente.nombre}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/factura/${factura.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && <div className="alert alert-warning">No Facturas found</div>
        )}
      </div>
      {totalItems ? (
