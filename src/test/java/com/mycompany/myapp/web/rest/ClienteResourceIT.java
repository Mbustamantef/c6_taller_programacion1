...
class ClienteResourceIT {
    ...
    private static final String DEFAULT_RUC_CI = "AAAAAAAAAA";
    private static final String UPDATED_RUC_CI = "BBBBBBBBBB";
    ...
    void getAllClientes() throws Exception {
        ...
        restClienteMockMvc
            ...
            .andExpect(jsonPath("$.[*].rucCi").value(hasItem(DEFAULT_RUC_CI)))
    ...
    void getCliente() throws Exception {
        ...
        restClienteMockMvc
            ...
            .andExpect(jsonPath("$.rucCi").value(DEFAULT_RUC_CI))
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.telefono(UPDATED_TELEFONO).email(UPDATED_EMAIL);
