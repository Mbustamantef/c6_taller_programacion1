...
class PagoResourceIT {
    ...
    public static Pago createEntity() {
        return new Pago().fechaPago(DEFAULT_FECHA_PAGO).monto(DEFAULT_MONTO).metodoPago(DEFAULT_METODO_PAGO);
    }
    ...
    public static Pago createUpdatedEntity() {
        return new Pago().fechaPago(UPDATED_FECHA_PAGO).monto(UPDATED_MONTO).metodoPago(UPDATED_METODO_PAGO);
    }
    ...
    void putExistingPago() throws Exception {
        ...
        updatedPago.fechaPago(UPDATED_FECHA_PAGO).monto(UPDATED_MONTO).metodoPago(UPDATED_METODO_PAGO);
    ...
    void partialUpdatePagoWithPatch() throws Exception {
        ...
        partialUpdatedPago.metodoPago(UPDATED_METODO_PAGO);
